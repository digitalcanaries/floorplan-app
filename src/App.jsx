...
function App() {
  ...
  return (
    <div className="h-screen flex flex-col bg-gray-900 text-white">
      ...
      {/* Annotate-saved toast — appears after the user hits Save in the
          image annotator. Auto-dismisses in 5s; "View" jumps to the
          References panel where the annotated ref actually lives, so
          Photo Notes (project-level) or per-set refs are equally findable. */}
      {annotateSavedNotice && (
